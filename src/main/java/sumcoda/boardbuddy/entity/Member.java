...
public class Member {
    ...
    @Builder
    public Member(String username, String password, String nickname, String email, String phoneNumber, String location, String latitude, String longitude, Integer buddyScore, Integer monthlyJoinCount, Integer totalJoinCount, Integer excellentCount, Integer goodCount, Integer badCount, Integer noShowCount, String description, Integer rank, MemberRole memberRole, ProfileImage profileImage) {
    ...
    public static Member createMember(String username, String password, String nickname, String email, String phoneNumber, String location, String latitude, String longitude, Integer buddyScore, Integer monthlyJoinCount, Integer totalJoinCount, Integer excellentCount, Integer goodCount, Integer badCount, Integer noShowCount, String description, Integer rank, MemberRole memberRole, ProfileImage profileImage) {
